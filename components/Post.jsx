      ...
      <div className="grid grid-cols-[48px,1fr] gap-4">
        ...
        <div>
          <div className="block sm:flex gap-1">
            ...
            <div className="flex">
              <p className="text-gray-500">@{post?.tag} &nbsp;&middot;&nbsp;</p>
          ...
          <div className="flex justify-between text-[20px] mt-4 w-[80%]">
            ...
            {session.user.uid !== post?.id ? (<FaRetweet className="hoverEffect w-7 h-7 p-1"/>) : (
              <RiDeleteBin5Line className="hoverEffect w-7 h-7 p-1" onClick={(e)=>{
                e.stopPropagation();
